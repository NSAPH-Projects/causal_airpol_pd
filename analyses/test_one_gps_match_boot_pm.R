...
i <- 3 # change the number to specify exposure
...
## DON'T FORGET TO SPECIFY BOOTSTRAP FOLDER

for (array_id in c(1:500)){
df <- read_fst(paste0("~/nsaph_projects/vwang_causal_airpol_pd/code/bootstrap_code/boot_dat_match_o3/boot_", array_id, ".fst"),
               as.data.table = T)
